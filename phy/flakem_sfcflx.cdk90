...
PUBLIC :: flake_sfcflx_lwradatm,  flake_sfcflx_lwradwsfc,   &
          flake_sfcflx_momsenlat, flake_sfcflx_rhoair,      &
          flake_sfcflx_roughness, flake_sfcflx_satwvpres,   &
          flake_sfcflx_spechum,   flake_sfcflx_wvpreswetbulb
...
!$OMP THREADPRIVATE (u_star_a_sf)
!$OMP THREADPRIVATE (Q_mom_a_sf,Q_sens_a_sf,Q_lat_a_sf,Q_watvap_a_sf)

!  Security constants
REAL (KIND = ireals), PARAMETER ::   &
  u_wind_min_sf  = 1.0E-02_ireals  , & ! Minimum wind speed [m s^{-1}]
  u_star_min_sf  = 1.0E-02_ireals  , & ! Minimum value of friction velocity [m s^{-1}]
  c_accur_sf     = 1.0E-04_ireals  , & ! A small number (accuracy)
...
!==============================================================================
!  The codes of the SfcFlx procedures are stored in separate "*.cdk" files
!  and are included below.
!------------------------------------------------------------------------------

!==============================================================================
include 'flake_sfcflx_lwradatm.h'

!==============================================================================

!==============================================================================
include 'flake_sfcflx_lwradwsfc.h'

!==============================================================================

!==============================================================================
include 'flake_sfcflx_momsenlat.h'

!==============================================================================

!==============================================================================
include 'flake_sfcflx_rhoair.h'

!==============================================================================

!==============================================================================
include 'flake_sfcflx_roughness.h'

!==============================================================================

!==============================================================================
include 'flake_sfcflx_satwvpres.h'

!==============================================================================

!==============================================================================
include 'flake_sfcflx_spechum.h'

!==============================================================================

!==============================================================================
include 'flake_sfcflx_wvpreswetbulb.h'

!==============================================================================

END MODULE flakem_SfcFlx
