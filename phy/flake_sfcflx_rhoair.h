...
REAL (KIND = ireals) FUNCTION flake_SfcFlx_rhoair (T, q, P)
...
flake_SfcFlx_rhoair = P/tpsf_R_dryair/T/(1._ireals+(1._ireals/tpsf_Rd_o_Rv-1._ireals)*q)

!------------------------------------------------------------------------------
!  End calculations
!==============================================================================

END FUNCTION flake_SfcFlx_rhoair
