...
REAL (KIND = ireals) FUNCTION flake_SfcFlx_lwradwsfc (T)
...
flake_SfcFlx_lwradwsfc = c_lwrad_emis*tpsf_C_StefBoltz*T**4_iintegers

!------------------------------------------------------------------------------
!  End calculations
!==============================================================================

END FUNCTION flake_SfcFlx_lwradwsfc
