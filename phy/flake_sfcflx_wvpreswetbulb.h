...
REAL (KIND = ireals) FUNCTION flake_SfcFlx_wvpreswetbulb (T_dry, T_wetbulb, satwvpres_bulb, P)             
...
REAL (KIND = ireals), INTENT(IN) ::   &
  ...
  satwvpres_bulb                    , & ! Saturation vapour pressure at wet-bulb temperature [N m^{-2}]
...
flake_SfcFlx_wvpreswetbulb = satwvpres_bulb & 
...
END FUNCTION flake_SfcFlx_wvpreswetbulb
