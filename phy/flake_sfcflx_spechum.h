...
REAL (KIND = ireals) FUNCTION flake_SfcFlx_spechum (wvpres, P)
...
flake_SfcFlx_spechum = tpsf_Rd_o_Rv*wvpres/(P-(1._ireals-tpsf_Rd_o_Rv)*wvpres)

!------------------------------------------------------------------------------
!  End calculations
!==============================================================================

END FUNCTION flake_SfcFlx_spechum
