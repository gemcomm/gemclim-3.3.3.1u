...
REAL (KIND = ireals) FUNCTION flake_SfcFlx_lwradatm (T_a, e_a, cl_tot, cl_low)
...
!  (see Fung et al. 1984, Zapadka and Wozniak 2000, Zapadka et al. 2001)  
flake_SfcFlx_lwradatm = -c_lwrad_emis*tpsf_C_StefBoltz*T_a**4_iintegers  &
...
END FUNCTION flake_SfcFlx_lwradatm
